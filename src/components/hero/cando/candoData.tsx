...
export const candoList = [
	{
		...
		description: (
			<div>
				...
				<p>
					This site was created by combining <b className="mx-1">Astro.js</b> with various frameworks.
				</p>
			</div>
		),
		button: (
	...
	},
	{
		...
		description: (
			<div>
				...
				<p>
					This site was created by combining <b className="mx-1">Astro.js</b> with{" "}
