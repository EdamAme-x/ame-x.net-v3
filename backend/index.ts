...
console.log(`\x1b[90m${new Date().toLocaleTimeString().split(" ")[0]}\x1b[0m \x1b[31m[hono]\x1b[0m Hono Initlizing...\x1b[0m`);
...
console.log(`\x1b[90m${new Date().toLocaleTimeString().split(" ")[0]}\x1b[0m \x1b[31m[hono]\x1b[0m Hono Initlized\x1b[0m \x1b[90m${Math.floor((performance.now() - beforeLoadTime) * 100) * 10}μs\x1b[0m`);
